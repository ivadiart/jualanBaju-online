...
<body>
  ...
  <main class="main">
    ...
    <section class="products section--lg container">
      <p class="total__products">We Found <span><?= $total_produk ?></span> items for you!</p>
          ...
          <div class="product__item">
            ...
            <div class="product__content">
              ...
              <a href="<?= base_url('details/' . $value['id']) ?>">
                <h3 class="product__title" title="" style="cursor:pointer;max-height: 80px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;"><?= $value['nm_produk']; ?></h3>
              </a>
              ...
              <div class="product__price">
                ...
                <br>
                <span class="old__price">Rp199.000</span>
              </div>

              <a href="details.php?id=" class="action__btn cart__btn" arial-label="Add To Cart">
    ...
    <div class="footer__container grid">
      <div class="footer__content">
        <a href="index.php" class="footer__logo">
          <img src="<?= base_url('assets/image/logo-ivanami.png') ?>" alt="" class="footer__logo-img">
        </a>
