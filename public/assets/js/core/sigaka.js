$(document).ready(function () {
	...
	// start
	// ------------------------------------------------------------------------------------------
	var root = window.location.origin + '/admin/';
	...
	$('.produk-hapus').click(function () {
		var id = $(this).val();
		var html = '' +
			'<a href="'+root+'data_produk'+id+'" class="btn btn-danger btn-bg-gradient-x-red-pink">Hapus</a>';
		$('#hapusproduk').html(html);
	});
